...
const VillageTable = () => {
    ...
    const village = useSelector((state) => state.adminEmployeeDetails.data.villageList)
    const loading = useSelector((state) => state.adminEmployeeDetails.data.villageLoading)
