            ...
            <div className='  mt-6 '>
                ...
                >
                   <div className='flex ml-2 ltr:ml-2 gap-3'>
                    <Button className="mr-2" icon={<HiPrinter /> } onClick={handlePrint}  >
                            Print
                        </Button>
                        <Button className="mr-2" icon={<HiOutlinePencil /> }   onClick={onEdit} >
                            Edit
                        </Button>
                    ...
                    <div className='flex ml-2 rtl:mr-2 gap-3'>
                        ...
                        <Button variant='solid' color='red-500' size='sm'>
                            Reject
                        </Button>
                    </div>
                </StickyFooter>
