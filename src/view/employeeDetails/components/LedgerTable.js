...
const LedgerTable = () => {
    ...
    const data = useSelector((state) => state.adminEmployeeDetails.data.ledgerList)
    const loading = useSelector((state) => state.adminEmployeeDetails.data.loading)
    const { status } = useSelector(
        (state) => state.adminEmployeeDetails.data.filterData
    )
    ...
    const { pageIndex, pageSize, query, total } = useSelector(
        (state) => state.adminEmployeeDetails.data.tableData
    )
